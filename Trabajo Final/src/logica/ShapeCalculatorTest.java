        ...
        do {
            switch (ShapeCalculatorUI.menuPrincipal()) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Forma trapecio = new Trapecio(ShapeCalculatorUI.peticionLadoA(), ShapeCalculatorUI.peticionLadoB(), ShapeCalculatorUI.peticionAltura(), ShapeCalculatorUI.peticionBaseMayor(), ShapeCalculatorUI.peticionBaseMenor());
